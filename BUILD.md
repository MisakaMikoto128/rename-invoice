...
### Autostart smoke (v1.0.2+)

1. 设置 → 开机启动 ON → 任务管理器「启动应用」 tab 可见 AccountManager ✓
2. 设置 → 开机启动 OFF → 任务管理器「启动应用」 tab AccountManager 消失 ✓

(系统托盘 / 关闭确认 / 单实例 这三个特性已撤回;
 详见 `docs/dev/flet-0.85-gotchas.md`)
